...
# Labels where the value represents a type
...
# Values where the number itself has mathematical meaning
numeric_features = [
    "Pclass",
    #"FarePerPerson",
    "Family_survive",
...
# Create function to introduce family linking with family Survived, Dead and Known
...
# Apply modeling pipeline to Train features using Train "Survived"
pipeline.fit(X_train, y_train)

# Use modelling output to predict Test results
