...
# ============================================================
# 1. Load engineered TRAIN data and train survival model
# ============================================================
...
survival_model = GradientBoostingClassifier()
...
# Compute age medians per title from df1 (raw train)
...
test['AgeBand'] = pd.cut(
    ...
    labels=[0, 1, 2, 3, 4, 5]
).astype(float).fillna(3)  # default to middle band if any edge case
...
# ============================================================
# We trained on X_train with columns = train_feature_cols
# So we must use the SAME columns (in same order) for test:
X_test_final = test[train_feature_cols]

# ============================================================
# 5. Predict Survived and build submission
# ============================================================
test['Survived'] = survival_model.predict(X_test_final)
